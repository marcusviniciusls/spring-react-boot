create table tb_movie (id int8 generated by default as identity, count int4, image varchar(255), score numeric(19, 2), title varchar(255), primary key (id));
create table tb_score (value numeric(19, 2), movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id));
